...
class SecurityTest extends TestCase
{
    ...
    public function test_security_settings_page_can_be_rendered(): void
    {
        ...
        $response->assertSee('Todavía no hay llaves de acceso');
        $response->assertSee('Autenticación de dos factores');
        $response->assertSee('Activar autenticación de dos factores');
    }
    ...
    public function test_security_settings_page_renders_without_two_factor_when_feature_is_disabled(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertDontSee('Administre sus llaves para iniciar sesión sin contraseña')
            ->assertDontSee('Agregue una llave para ingresar sin contraseña')
